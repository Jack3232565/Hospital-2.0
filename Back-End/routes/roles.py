...
@roles.post("/roles/", response_model=schemas.roles.Rol, tags=["Tbc_Roles"])
...
@roles.put("/roles/{id}", response_model=schemas.roles.Rol, tags=["Tbc_Roles"])
...
@roles.delete("/roles/{id}", response_model=schemas.roles.Rol, tags=["Tbc_Roles"])
