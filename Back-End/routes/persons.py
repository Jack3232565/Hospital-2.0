...
@person.get("/persons/", response_model=List[schemas.persons.Person], tags=["Persons"])
...
@person.post("/person/{id}", response_model=schemas.persons.Person, tags=["Persons"])
...
@person.post("/person/", response_model=schemas.persons.Person, tags=["Persons"])
...
@person.put("/person/{id}", response_model=schemas.persons.Person, tags=["Persons"])
...
@person.delete("/person/{id}", response_model=schemas.persons.Person, tags=["Persons"])
