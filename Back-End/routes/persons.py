...
@person.post("/person/{id}", response_model=schemas.persons.Person, tags=["Tbb_Personas"])
...
@person.put("/person/{id}", response_model=schemas.persons.Person, tags=["Tbb_Personas"])
...
@person.delete("/person/{id}", response_model=schemas.persons.Person, tags=["Tbb_Personas"])
