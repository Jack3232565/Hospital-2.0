    ...
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-6xl">
        ...
        <div class="w-full p-8 lg:w-1/2">
            ...
            <a href="#" class="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                ...
                <h1 class="px-4 py-3 w-5/6 text-center text-gray-600 font-bold">Inicia secion con Google</h1>
            </a>
            <div class="mt-4 flex items-center justify-between">
                <span class="border-b w-1/5 lg:w-1/4"></span>
                <a href="#" class="text-xs text-center text-gray-500 uppercase">o ingresa con tu email</a>
                <span class="border-b w-1/5 lg:w-1/4"></span>
            </div>
            <div class="mt-4">
                <label class="block text-gray-700 text-sm font-bold mb-2">Tu Direccion de Correo </label>
            ...
            <div class="mt-8">
                <RouterLink to="/register">
                  <button class="bg-gray-500 text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-400">Registrate</button>
                </RouterLink>
              </div>
        </div>
    </div>
